  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        ...
        >
          <MoonStarIcon
            className='scale-100 rotate-0 transition-all duration-300 dark:-rotate-90 dark:scale-0'
            aria-hidden='true'
          />
          <SunIcon
            className='absolute scale-0 rotate-90 transition-all duration-300 dark:rotate-0 dark:scale-100'
            aria-hidden='true'
          />
