            ...
            >
              <CardContent className='space-y-3.5'>
                ...
                <div className='flex items-center justify-between gap-1.5'>
                  ...
                  {/* ⚡ Bolt: Use relative z-10 for the Badge to keep it clickable over the stretched link. */}
                  <Badge asChild className='bg-primary/10 text-primary relative z-10 border-0 text-sm'>
                    <button
                      type='button'
                      onClick={e => {
                        e.preventDefault()
                ...
                <h3 className='line-clamp-2 text-lg font-medium md:text-xl'>
                  {/* ⚡ Bolt: Implement stretched link pattern for better accessibility and SEO. */}
                  <Link
